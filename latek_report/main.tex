...
Ce chapitre inaugure la Partie 4 et présente l'\textbf{Étape 1 : Transfer Learning Séquentiel} (pré-entraînement BF puis fine-tuning HF). L'objectif est de tester si une phase d'apprentissage large sur données peu coûteuses peut servir de socle, puis être spécialisée rapidement sur une fraction réduite de données HF.
